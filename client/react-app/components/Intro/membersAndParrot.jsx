...
export const MembersAndParrot = () => {
	...
	return (
		<div
			className={style.membersAndParrot_container}
			ref={membersAndParrot_container}
		>
			<div
				className={style.membersAndParrot_leafs_block}
				data-scroll
				data-scroll-speed="2"
			...
			>
				<div className={style.membersAndParrot_leafs_block_container}>
					<div
						...
						className={style.membersAndParrot_leafs1}
						ref={membersAndParrot_leafs1}
					>
						<Image src={I.leafs1} />
					</div>
					<div
						...
						data-scroll-position="top"
						data-scroll-direction="horizontal"
						className={style.membersAndParrot_leafs2}
						ref={membersAndParrot_leafs2}
					>
						<Image src={I.leafs2} />
					</div>
					<div
						...
						data-scroll-direction="horizontal"
						className={style.membersAndParrot_leafs3}
						ref={membersAndParrot_leafs3}
					>
						<Image src={I.leafs3} />
					</div>
					<div
						...
						data-scroll-position="top"
						data-scroll-direction="horizontal"
						className={style.membersAndParrot_leafs4}
						ref={membersAndParrot_leafs4}
					>
						<Image src={I.leafs4} />
					</div>
					<div
						...
						data-scroll-position="top"
						data-scroll-direction="horizontal"
						className={style.membersAndParrot_leafs5}
						ref={membersAndParrot_leafs5}
					>
						<Image src={I.leafs5} />
					</div>
				</div>
			...
			<div
				...
				data-scroll-position="top"
				data-scroll-direction="horizontal"
				className={style.membersAndParrot_parrot_block}
				ref={parrot_block}
			>
				<Image
					className={style.membersAndParrot_parrot}
					src={I.parrot}
				/>
			</div>

			<div
				className={style.members_container}
			...
			>
				...
				<div className={style.members_block_info}>
					<span className={style.members_block_info_text}>Members</span>
					<CountUp
						start={0}
						end={members}
						delay={0}
					...
					>
						{({ countUpRef }) => (
							<span
								ref={countUpRef}
								className={style.members_block_info_numbers}
							></span>
						)}
					</CountUp>
				</div>
