...
export const NatureNeedsYou = () => {
	...
	return (
		...
		>
			<div
				className={style.natureNeedsYou_img}
				ref={natureNeedsYou_img}
			>
				<Image
					src={I.natureNeedsYou}
					alt="Nature needs you calligraphy"
				/>
			</div>

			<p
				className={style.natureNeedsYou_text}
				ref={natureNeedsYou_text}
			>
