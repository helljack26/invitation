...
--
-- Хост: mysql
-- Время создания: Ноя 24 2024 г., 19:20
...
(32, 'test', 'test', 4, '2023-10-17 11:19:30');
...
(1, 'view_content', 'Can view content'),
(2, 'edit_content', 'Can edit existing content'),
(3, 'create_content', 'Can create new content'),
(4, 'delete_content', 'Can delete content'),
(5, 'manage_users', 'Can manage user accounts'),
(6, 'manage_settings', 'Can change system settings'),
(7, 'unrestricted_access', 'Can bypass all restrictions'),
(8, 'admin_viev_edit_content', 'Edit, viev all, viev with id'),
(9, 'assign_role', 'Призначення ролі користовачу'),
(10, 'calculate_taxes_own', 'Показывать данные по налогам'),
(11, 'calculate_taxes_any', 'Показывать данные по налогам любой компании'),
(12, 'get_kveds', 'Получить кведы предприятия'),
(13, 'add_kved', 'Добавить квед'),
(14, 'delete_kved', 'Удалить квед'),
(15, 'add_standard_account_group', 'Добавления стандартных груп для расчетных счетов, используется при создани/выборе групы счетов дял предприятия'),
(16, 'update_standard_account_group', 'Обновление стандартных груп для расчетных счетов, используется при создании/выборе групы счетов для предприятия'),
(17, 'delete_standard_account_group', 'Добавления стандартных груп для расчетных счетов, используется при создани/выборе групы счетов для предприятия'),
(18, 'get_standard_account_from_plan', 'Получить стандартные планы'),
(19, 'delete_standard_account_from_plan', 'Удалить стандартный план счета'),
(20, 'update_standard_account_in_plan', 'Обновить стандартный план счетов'),
(21, 'add_standard_account_to_plan', 'Добавить стандартный план счетов'),
(22, 'add_enterprise_account_plan', 'Добавлять планы счетов'),
(23, 'get_enterprise_accounts_from_plan', 'Получить планы предприятий'),
(24, 'add_account_to_plan', 'Добавить план счетов предприятию'),
(25, 'delete_account_from_plan', 'Удалить план счетов предприятия'),
(26, 'update_account_in_plan', 'Обновить план счетов предприятия'),
(27, 'get_account', 'Отримати список контрагентів власної компанії'),
(28, 'update_account', 'Дає можливість змінювати данні контрагента'),
(29, 'create_account', 'Створення контрагентів\" надає користувачам можливість створювати нових контрагентів у системі.'),
(30, 'del_account', 'Удалить контрагента'),
(31, 'get_contacts', 'Отримати список контактів'),
(32, 'del_contact', 'Удалить контакт'),
(33, 'create_contact', 'Створення контактів \" надає користувачам можливість створювати нових контактів у системі.'),
(34, 'update_contact', 'Дає можливість змінювати данні контакту'),
(35, 'view_company_info', 'Просмотр информации о компании'),
(36, 'view_company_employees', 'Просмотр сотрудников компании'),
(37, 'user_role_get', 'Отримання ролі користувача');
...
INSERT INTO `Roles` (`id`, `company_id`, `role_name`, `description`, `permissions`, `is_default`) VALUES
(1, 1, 'global_admin', 'Torgsoft Workers', '[\"get_standard_account_from_plan\", \"view_content\", \"unrestricted_access\", \"manage_settings\", \"manage_users\", \"create_content\", \"edit_content\", \"delete_content\", \"calculate_taxes_any\", \"add_kved\", \"delete_kved\", \"get_kveds\", \"delete_standard_account_from_plan\", \"update_standard_account_in_plan\", \"add_standard_account_to_plan\", \"view_company_info\", \"update_account\", \"get_account\", \"update_contact\", \"create_contact\", \"update_account_in_plan\", \"delete_account_from_plan\", \"del_contact\", \"get_contacts\", \"add_account_to_plan\", \"delete_standard_account_group\", \"update_standard_account_group\", \"get_enterprise_accounts_from_plan\", \"del_account\", \"add_enterprise_account_plan\", \"view_company_employees\", \"create_account\", \"add_standard_account_group\", \"admin_viev_edit_content\", \"assign_role\", \"calculate_taxes_own\", \"user_role_get\"]', 0),
(6, 1, 'Manager', 'Role for managing content and users', '[\"create_content\", \"delete_content\", \"manage_users\", \"edit_content\", \"view_content\", \"unrestricted_access\", \"manage_settings\", \"admin_viev_edit_content\", \"assign_role\"]', 0);
...
(6, 'RegTestNameUsername', 'regtest@example.com', NULL, '$2y$10$W.XhxrrY3PvrXaW6yW26LeEVxZtaGyCnd7rkYUI0L98i7ou/3oKIO', 'RegTestNameFirst', 'RegTestNameSecond', 'RegTestNameLast', NULL, '2024-01-17 08:12:53');
